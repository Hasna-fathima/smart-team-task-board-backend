...
const seedData = async () => {
  try {
    ...
    console.log('[Seeder]: Created 4 users (Admin, Manager, Employee 1, Employee 2)');
    ...
    console.log('[Seeder]: Created workspace: Engineering & Product Hub');
    ...
    console.log('[Seeder]: Created active sprint');
    ...
    console.log(`[Seeder]: Created ${insertedTasks.length} tasks`);
    ...
    console.log('[Seeder]: Activity logs created successfully!');
    console.log('====================================================');
    console.log('SEEDING COMPLETED SUCCESSFULY!');
    console.log('Test Accounts:');
    console.log('1. Admin:    admin@taskboard.com / admin123');
    console.log('2. Manager:  manager@taskboard.com / manager123');
    console.log('3. Employee 1: employee1@taskboard.com / emp123');
    console.log('4. Employee 2: employee2@taskboard.com / emp123');
    console.log('====================================================');
